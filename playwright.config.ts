...
export default defineConfig({
  testDir: "./tests/smoke",
  testIgnore: persistenceMode === "postgres" ? [] : ["**/zz-stage16-imports.spec.ts", "**/zz-stage17-exports.spec.ts", "**/zz-stage18-exercise.spec.ts", "**/zz-stage19-readiness.spec.ts", "**/zz-stage21-admin-configuration.spec.ts"],
  timeout: 30_000,
  expect: {
    timeout: 10_000
  },
