...
export type NotificationOutboxInput = {
  eventType: "SESSION_CLOSED" | "ASSIGNMENT_ASSIGNED" | "ASSIGNMENT_CANCELLED" | "ASSIGNMENT_ESCALATED" | "ROSTER_PUBLISHED" | "TRAINING_ASSIGNED" | "DOCUMENT_REQUIREMENT_CREATED" | "DOCUMENT_REQUIREMENT_UPDATED";
