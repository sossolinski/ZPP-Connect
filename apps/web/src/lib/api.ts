...
export const api = {
  ...
  removeAvailability: (id: string) => request<AnyRecord>(`/availability/${id}/remove`, { method: "POST", body: JSON.stringify({}) }),
  ...
  assignmentAssignees: () => request<ApiList<AnyRecord>>("/assignment-assignees"),
