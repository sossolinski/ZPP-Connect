...
Dokładnie jeden proponowany następny pionowy slice: **Assignments Persistence + Ownership + Controlled Workflow**, ponieważ `AssignmentTask` jest najbliższym pozostałym incidentowym workflow z pamięciowymi i starymi direct-Prisma write paths. Stage 7 nie rozpoczyna tego slice.
